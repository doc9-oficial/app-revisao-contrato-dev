...
interface VerificarConformidadeParams {
  parametro: string;
  filtro?: string;
}

async function verificarConformidade(params: VerificarConformidadeParams): Promise<void> {
  try {
    ...
    console.log(`Executando verificarConformidade com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Verifica conformidade do contrato com normas concluído com sucesso",
      resultado: {
...
export default verificarConformidade;
